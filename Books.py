...
#  Description: Compare vocabulary of two authors using input texts
...
def wordComparison(author1, freq1, author2, freq2):
  ...
  print('Ratio (% of total distinct words to total words) =', format(wordCount1/totalCount1*100,'.10f'))
  print()
  
  print(author2)
  print('Total distinct words =', wordCount2)
  print('Total words (including duplicates) =', totalCount2)
  print('Ratio (% of total distinct words to total words) =', format(wordCount2/totalCount2*100,'.10f'))
  print()
                                                            
  print('%s used %d words that %s did not use.' %(author1, len(diff1), author2))
  print('Relative frequency of words used by', author1,'not in common with', author2, '=', format(count1/totalCount1*100,'.10f'))
  print()
  print('%s used %d words that %s did not use.' %(author2, len(diff2), author1))
  print('Relative frequency of words used by', author2, 'not in common with', author1, '=', format(count2/totalCount2*100,'.10f'))
  print()
